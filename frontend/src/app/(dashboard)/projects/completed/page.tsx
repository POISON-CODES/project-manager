 ...
 * Displays initiatives that have been successfully finalized.
 */
    ...
    React.useEffect(() => {
        const fetchCompletedProjects = async () => {
            try {
                ...
                const completed = allProjects.filter(p => p.status === 'DONE');
        ...
        <div className="space-y-6 animate-in fade-in slide-in-from-bottom-2 duration-500">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div>
                    ...
                    <p className="text-muted-foreground leading-relaxed">Archive of successfully delivered initiatives and historical tracks.</p>
                </div>
            </div>
            ...
            {isLoading ? (
                ...
                <Card className="bg-surface/30 border-border border-dashed py-32 rounded-3xl">
                    <div className="flex flex-col items-center justify-center text-center px-6">
                        ...
                        <h3 className="text-xl font-bold tracking-tight">Archive Empty</h3>
                        <p className="text-muted-foreground max-w-sm mt-2 text-sm">
                            No projects have been marked as completed yet.
                        </p>
                    </div>
                </Card>
            ) : (
